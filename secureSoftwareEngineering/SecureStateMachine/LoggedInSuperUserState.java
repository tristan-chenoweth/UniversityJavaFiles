public class LoggedInSuperUserState implements SecurityState {

    SecureSystem system;
    UserFunctionsMachine machine;

    public LoggedInSuperUserState(SecureSystem secureSystem, UserFunctionsMachine userFunctionsMachine) {
    ...
    public String toString() {
        return "Logged In SuperUser State";
    }
}
