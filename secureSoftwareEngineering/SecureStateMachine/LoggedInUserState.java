public class LoggedInUserState implements SecurityState {

    SecureSystem system;
    UserFunctionsMachine machine;

    public LoggedInUserState(SecureSystem secureSystem, UserFunctionsMachine userFunctionsMachine) {
